...
const products = [
  {
    ...
    price: "$0.50",
    period: "/month",
    features: ["Full Warranty", "Duration : 28-30Days", "In Most Case Custom Domain But Sometimes @gmail.com or @outlook.com / @hotmail.com", "Cheapest In Market"],
    icon: Crown,
    popular: true,
